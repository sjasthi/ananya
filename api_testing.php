                        ...
                        <table id="testSuite" class="table table-dark table-striped table-sm table-bordered" style="display:table;">
                            ...
                            <tbody id="apiTable">
                                ...
                                $sections = array(
                                    ...
                                    "Character Validation" => array("containsAllLogicalChars", "containsChar", "containsLogicalChars", "containsLogicalCharSequence", "containsSpace", "containsString", "endsWith", "charVowel", "startsWith"),
