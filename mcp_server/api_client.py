...
class AnanyaAPIClient:
    ...
    async def analysis_is_consonant(self, string: str, language: str = "english") -> Any:
        data = await self._call("analysis", "is-consonant", {"string": string, "language": language})
        return self._extract_result(data)
    ...
    async def analysis_character_role(self, string: str, language: str = "english") -> Any:
        data = await self._call("analysis", "role", {"string": string, "language": language})
        return self._extract_result(data)
    ...
    async def analysis_unique_intersecting_characters(self, string1: str, string2: str, language: str = "english") -> Any:
        data = await self._call("analysis", "unique-intersecting-chars", {
            "string": string1, "input2": string2, "language": language
        })
        return self._extract_result(data)

    async def analysis_unique_intersecting_rank(self, string1: str, string2: str, language: str = "english") -> Any:
        data = await self._call("analysis", "unique-intersecting-rank", {
            "string": string1, "input2": string2, "language": language
        })
        return self._extract_result(data)
    ...
    # ── CHARACTER OPERATION APIs ──────────────────────────────────────────────────

    async def characters_add_at(self, string: str, char: str, index: int = 0, language: str = "english") -> Any:
        data = await self._call("characters", "add-at", {
            "string": string, "input2": str(index), "input3": char, "language": language
        })
        return self._extract_result(data)

    async def characters_add_end(self, string: str, char: str, language: str = "english") -> Any:
        data = await self._call("characters", "add-end", {
    ...
    async def characters_base_consonants(self, string: str, language: str = "english") -> Any:
        data = await self._call("characters", "base-consonants", {"string": string, "language": language})
        return self._extract_result(data)
    ...
    async def characters_filler(self, string: str, language: str = "english") -> Any:
        data = await self._call("characters", "filler", {"string": string, "language": language})
        return self._extract_result(data)
    ...
    async def validation_contains_logical_sequence(self, string: str, sequence: str, language: str = "english") -> Any:
        data = await self._call("validation", "contains-logical-sequence", {
            "string": string, "input2": sequence, "language": language
        })
        return self._extract_result(data)
    ...
    async def validation_ends_with(self, string: str, suffix: str, language: str = "english") -> Any:
        data = await self._call("validation", "ends-with", {
    ...
    async def validation_starts_with(self, string: str, prefix: str, language: str = "english") -> Any:
        data = await self._call("validation", "starts-with", {
    ...
    async def comparison_compare_ignore_case(self, string1: str, string2: str, language: str = "english") -> Any:
        data = await self._call("comparison", "compare-ignore-case", {
            "string": string1, "input2": string2, "language": language
        })
        return self._extract_result(data)

    async def comparison_compare_to(self, string1: str, string2: str, language: str = "english") -> Any:
        data = await self._call("comparison", "compare-to", {
            "string": string1, "input2": string2, "language": language
        })
        return self._extract_result(data)
    ...
    async def comparison_is_intersecting(self, string1: str, string2: str, language: str = "english") -> Any:
        data = await self._call("comparison", "is-intersecting", {
            "string": string1, "input2": string2, "language": language
        })
        return self._extract_result(data)
    ...
    async def utility_index_of(self, string: str, search: str, language: str = "english") -> Any:
        data = await self._call("utility", "index-of", {
            "string": string, "input2": search, "language": language
        })
        return self._extract_result(data)

    async def utility_language(self, language: str) -> Any:
        data = await self._call("utility", "language", {"string": language})
        return self._extract_result(data)

    async def utility_length_alternative(self, string: str, language: str = "english") -> Any:
        data = await self._call("utility", "length-alternative", {"string": string, "language": language})
        return self._extract_result(data)
